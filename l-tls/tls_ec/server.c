...
int main(int argc, char **argv) {
    ...
    if((ret = mbedtls_x509_crt_parse(&srv_cert, (const unsigned char *) mbedtls_test_srv_crt_ec, mbedtls_test_srv_crt_ec_len)) != 0) {
#if defined(MBEDTLS_DEBUG_C)
    ...
    if((ret = mbedtls_pk_parse_key(&srv_key, (const unsigned char *) mbedtls_test_srv_key_ec, mbedtls_test_srv_key_ec_len, NULL, 0)) != 0) {
#if defined(MBEDTLS_DEBUG_C)
