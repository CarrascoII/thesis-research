...
ENDPOINTS=(srv cli)
# TODO: verify size of the keys in each curve. EC generation uses option "ec_curve="
# EC_KEY_SIZES=(160 224 256 512)
# ECC_KEY_SIZES=(192 240 320 512)
# KEY_SIZES=(RSA_KEY_SIZES ECC_KEY_SIZES)

# declare -n sizes

# for sizes in ${EC_CURVES[@]}
# do
#     for size in ${sizes[@]}
#     do
#         echo "Printing ${size}"
...
find examples/ -mindepth 0 -type f -name '*.*' -delete
