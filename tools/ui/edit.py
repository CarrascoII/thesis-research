...
class Ui_DialogEdit(object):
    def setupUi(self, DialogEdit):
        ...
        self.frame_2.setGeometry(QtCore.QRect(10, 80, 360, 270))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.listView.setGeometry(QtCore.QRect(10, 10, 200, 250))
        ...
        self.lineEdit.setGeometry(QtCore.QRect(230, 140, 120, 30))
        self.lineEdit.setClearButtonEnabled(True)
        self.lineEdit.setObjectName("lineEdit")
        self.frame = QtWidgets.QFrame(DialogEdit)
        self.frame.setGeometry(QtCore.QRect(10, 10, 360, 71))
